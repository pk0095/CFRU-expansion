...
.word DESC_SAPPYSEED
.word DESC_ZIPPYZAP
.word DESC_FREEZYFROST
.word DESC_SPARKLYSWIRL
.word DESC_BOUNCYBUBBLE
.word DESC_FLOATYFALL
.word DESC_BUZZYBUZZ
.word DESC_GLITZYGLOW
.word DESC_SIZZLYSLIDE
.word DESC_BADDYBAD
.word DESC_SPLISHYSPLASH
.word DESC_SHADOWSTORM
.word DESC_OVERCHARGE
.word DESC_ACIDRUST
.word DESC_PHANTOMVOID
.word DESC_NIHILLIGHT
.word DESC_VEEVEEVOLLEY
.word DESC_PIKAPAPOW
.word DESC_STATICWING
.word DESC_SPIRITLEECH
.word DESC_MOURNFULGAZE
.word DESC_HYDROBLAST
.word DESC_MAELSTROM