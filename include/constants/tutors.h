...
enum MoveTutors
{
    ...
    TUTOR147_CHILLING_WATER,
    TUTOR148_POUNCE,
    TUTOR149_TRAILBLAZE,
    TUTOR150_ICE_SPINNER,
    TUTOR151_TERABLAST,
    TUTOR152_DRAGON_CHEER,
    TUTOR153_HARD_PRESS,
    TUTOR154_ALLURING_VOICE,
    TUTOR155_PSYCHIC_NOISE,
    TUTOR156_TEMPER_FLARE,
    TUTOR157_SUPERCELL_SLAM,
    TUTOR158_UPPER_HAND,
    TUTOR159_SUCKER_PUNCH,
    TUTOR160_ANCIENT_POWER,
    TUTOR161_ZAP_CANNON,
    TUTOR162_METRONOME,
    TUTOR163_DYNAMIC_PUNCH,
    TUTOR164_COIL,
    TUTOR165_VICTORY_DANCE,
    TUTOR166_SEISMIC_TOSS,
    TUTOR167_COUNTER,
    TUTOR168_MIRROR_COAT,
    TUTOR169_MUD_SLAP,
    TUTOR170_ROLLOUT,
    TUTOR171_MIMIC,
	//NUM_MOVE_TUTORS
...
{
	TUTOR_SPECIAL_DRACO_METEOR = NUM_MOVE_TUTORS,	//172 - Dragon Pokemon
	TUTOR_SPECIAL_SECRET_SWORD,						//173 - Keldeo only
	TUTOR_SPECIAL_RELIC_SONG,						//174 - Meloetta only
	TUTOR_SPECIAL_VOLT_TACKLE,						//175 - Pikachu only
	TUTOR_SPECIAL_DRAGON_ASCENT,					//176 - Rayquaza only
	TUTOR_SPECIAL_THOUSAND_ARROWS,					//177 - Zygarde only
	TUTOR_SPECIAL_THOUSAND_WAVES,					//178 - Zygarde only
	TUTOR_SPECIAL_CORE_ENFORCER,					//179 - Zygarde only
	TUTOR_SPECIAL_STEEL_BEAM,						//180 - Steel Pokemon
};
